...
# Cargar el modelo h5
modelo_h5 = 'models/riesgo.h5'
riesgo_model = load_model(modelo_h5)

images = []
# AQUI ESPECIFICAMOS UNAS IMAGENES
filenames = ['mariquita6.jpg','mariquita7.jpg','mariquita8.jpg']
...
sriesgos = ['gato','hormiga','mariquita','perro','tortuga']  # Reemplaza con tus etiquetas reales
